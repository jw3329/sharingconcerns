            ...
            <div className="card">
                ...
                <div className="card-body">
                    ...
                    <div className="row mt-5">
                        <button className="justify-content-start btn btn-success m-3" onClick={handleLike}>Like({post.likes.length})</button>
                        <button className="justify-content-end btn btn-danger m-3" onClick={handleDislike}>Dislike({post.dislikes.length})</button>
                    </div>
                </div>
            </div>
            <Comment id={id} />
